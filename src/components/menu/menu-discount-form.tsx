...
const MenuDiscountForm = (props: { mode: "new" | 'update', id?: string,data?:any }) => {
      ...
      {({ isSubmitting }) => (
        <Form>
          ...
          <div className='mb-2'>
            ...
            <Field type="number" id="name" name="name" as={Input} />
          ...
          <div className='mb-2'>
           ...
           <div className='mb-2'>
            <label htmlFor="isDefault">Is Active</label>
...
export default MenuDiscountForm;
